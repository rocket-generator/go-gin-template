...
// NewUnauthorizedError ... Return when the user is not authorized
func NewUnauthorizedError(message string) *Status {
	return NewErrorStatus(ServiceUnavailableError, message)
}
